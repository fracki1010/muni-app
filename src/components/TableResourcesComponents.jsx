...
export const TableResourcesComponents = ({ onOpenDrawer }) => {
  const { startDeletingResourceGroup, startDeletingResourceById } =
    useMuniStore();
  ...
  const onSelectionChange = (e) => {
    const arraySelected = [];
    if (e === "all") {
      for (let entrada of filterResources) {
                    ...
                    <Dropdown backdrop="blur">
                      ...
                      <DropdownMenu aria-label="Static Actions" variant="faded">
                        <DropdownItem
                          ...
                          // }}
                          onPress={() => navigate(`/resources/${item.id}`)}
                          key="watch"
                        >
                          Ver
                        </DropdownItem>
                        <DropdownItem
                          ...
                          color="danger"
                          onPress={() => startDeletingResourceById(item.id)}
                        >
                          Eliminar
                        </DropdownItem>
                      </DropdownMenu>
